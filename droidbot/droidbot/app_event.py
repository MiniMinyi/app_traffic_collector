...
class AppEventManager(object):
    ...
    def __init__(self, device, app, event_policy, no_shuffle, no_textview,
    ...
    def get_event_factory(self, device, app):
        ...
        if policy == POLICY_NONE:
            ...
            event_factory = UtgDfsFactory(device, app, self.no_shuffle, self.no_textview)
...
class UtgDfsFactory(StateBasedEventFactory):
    ...
    def __init__(self, device, app, no_shuffle, no_textview):
    ...
    def select_a_view(self, state):
        ...
        views = []
        for view in state.views:
            if self.no_textview and view['class'] and view['class'] == "android.widget.EditText":
                continue
            if view['enabled'] and len(view['children']) == 0 and DeviceState.get_view_size(view) != 0:
                views.append(view)
